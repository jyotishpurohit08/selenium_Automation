...
public class stg_Admin_User_Management {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(5000);
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("document.getElementById('menu-list-18-menuitem-9').click()");
		System.out.println("done__________________!");
		Thread.sleep(8000);
		driver.findElement(By.name("userid")).sendKeys("1");
		Thread.sleep(3000);
		driver.findElement(By.name("username")).sendKeys("user_A");
		Thread.sleep(5000);
		...
		driver.findElement(By.cssSelector(
				"#__next > form > div.chakra-container.desktop_main_content_div.admin_main_content_div.css-10gf8jm > div.content_content_div.css-0 > div > div.cast_list.css-0 > div > div.table_box.css-0 > div > table > tbody > tr:nth-child(1) > td:nth-child(5) > div.custom_btn_box.css-0 > button:nth-child(1)"))
				.click();
		Thread.sleep(8000);
		driver.findElement(By.xpath("//*[@id=\"__next\"]/div[2]/div[2]/div/div/div/div[1]/div/button[1]")).click();
		Thread.sleep(5000);
		driver.findElement(By.cssSelector(
				"#__next > form > div.chakra-container.desktop_main_content_div.admin_main_content_div.css-10gf8jm > div.content_content_div.css-0 > div > div.cast_list.css-0 > div > div.table_box.css-0 > div > table > tbody > tr:nth-child(1) > td:nth-child(5) > div.custom_btn_box.css-0 > button:nth-child(2)"))
				.click();
		Thread.sleep(5000);
